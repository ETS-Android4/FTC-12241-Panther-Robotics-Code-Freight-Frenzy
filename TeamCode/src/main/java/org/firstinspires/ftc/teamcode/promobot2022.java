...
public class promobot2022 {
    ...
    public void init(HardwareMap ahwMap, Telemetry telem) {
        ...
        //Define servos
        conveyer = hwMap.get(Servo.class, "con");
...
//        setCapArm(1);
    ...
    public void setRegula1(double power,  double maxTime) {
        regula1.setPower(power);
    }
/*
    public void setBaller(double power, double maxTime) {
        baller.setPower(power);
    }


    public void setCarousel(double power, double maxTime) {
        carousel.setPower(power);
    }*/
    public void setConveyer(boolean deploy) {
        conveyer.setPosition(deploy ? 0.5 : 0.0);
    }
